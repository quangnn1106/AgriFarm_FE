...
const LandPage = (props: Props) => {
  ...
  const [bills, setBills] = useState<BillModel[] | undefined>(billData);
  ...
  const breadCrumb = [
    ...
    {
      title: <Link href={`/bill-payment`}>Manage Bill Payment</Link>
    }
  ];
            ...
            >
              <Content style={{ padding: '0 24px', minHeight: 280 }}>
                <Table
                  ...
                  //     };
                  //   }}
                  columns={BillPaymentTableColumns()}
                  dataSource={bills?.map(bills => ({
                    ...bills
                    // onDetails: () => handleDetails(fertilizer.id!),
                    //    onDelete: () => handleDelete(bills.id!)
