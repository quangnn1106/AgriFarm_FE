...
import { addNewWaterApi } from '@/services/Admin/Water/addNewWater';
...
const AddWater = ({
  ...
  const handleForm = async (values: WaterPayLoadRequest) => {
    ...
    const res = await addNewWaterApi(http, allValues);
          ...
          >
            ...
            >
              ...
              >
                <Form.Item
                  name='name'
                  label={<TitleLabelFormItem name='Water Name'></TitleLabelFormItem>}
                >
                  <Input size='large' />
                </Form.Item>
